...
class InferenceConfig:
    lm: LMConfig = field(default_factory=LMConfig)  # Use field with default_factory
    model: ModelConfig = field(default_factory=ModelConfig)  # Use field with default_factory
